...
public class PlayerController : MonoBehaviour
{
    ...
    void GetInput()
    {
        ...
        // If sprint button is held down, then moveMultipler is equal to sprintMultiplier, else it is 1
        moveMultipler = Input.GetButton("Sprint") ? sprintMultiplier : 1;
    }

    void MovePlayer()
    {
        characterController.Move((transform.forward * vertical + transform.right * horizontal) * moveSpeed * Time.deltaTime * moveMultipler);
